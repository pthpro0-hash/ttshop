...
- 내정보 이력: 보유포인트, 구매이력, 추천링크별 최근 10개 및 더보기 표시
...
- Admin 대리점관리: 필수 계약 정보와 운영 정보를 분리해 대리점 등록/수정/삭제, 정산 상태 변경, 전용 링크 복사 관리
...
- 정산 상태: Admin은 정산 장부를 대기/확정/지급완료/보류로 변경 가능, Agency는 상태 확인만 가능

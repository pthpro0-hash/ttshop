...
- 회원명 클릭 시 실서비스형 내정보 팝업 표시: 요약 대시보드, 계정/배송지, 구매 내역, 포인트 관리, 추천 링크, 보안 탭 구성
- 내정보 비밀번호 변경: 기존 비밀번호 검증 후 새 비밀번호 저장
- 내정보 배송지 관리: 기본 배송지와 추가 배송지 저장, 배송지 목록 표시
...
- 내정보 주문 상세: 구매이력에서 주문별 상품, 결제금액, 배송비, 포인트 사용/적립, 대리점 정보 확인
...
- Admin 대리점관리: 필수 계약 정보와 운영 정보, 대리점 로그인 계정을 분리해 대리점 등록/수정/삭제, 정산 상태 변경, 전용 링크 복사 관리
...
- 내정보: 아이디는 읽기 전용이며 이름, 휴대폰, 이메일, 기본/추가 배송지, 기본 결제수단, 관심 카테고리, 수신 설정 수정 가능
- 내정보 이력: 구매이력과 포인트 적립/사용 이력 확인 가능
- 내정보 주문 상세: 구매이력의 상세 보기에서 상품별 수량/옵션, 결제금액, 배송비, 사용 포인트, 적립 포인트 확인 가능
